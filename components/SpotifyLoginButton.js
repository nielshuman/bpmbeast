...
export function normal(props) {
    return <a href="/api/login" {...props} style={{width: props.width}} className={[styles.btn, styles.black].join(' ')}>
        <div className={styles.container}>
            <Image src="/SpotifyIcons/Spotify_Icon_RGB_Green.png" alt="Spotify Logo" width={30} height={30} />
